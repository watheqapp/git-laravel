...
<div class="">
    ...
    <span class="badge badge-roundless" style="background-color: red;">{{__('backend.activeted')}}</span>
    <span class="badge badge-roundless" style="background-color: #ccc;">{{__('backend.Not login yet')}}</span>
    <br /><br />
    @parent
</div>
